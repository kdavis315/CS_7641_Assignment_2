...
while n in range (2, 11):
    ...
    rhc_co.append(bestfit)


    n+=1
#print(rhc_co)
rhc_co_table = pd.DataFrame(rhc_co)
rhc_co_table.columns = ['Run_no', 'best_state', 'best_fitness', 'bits', 'iterations', 'attempts']
no_bits = rhc_co_table['bits']
b_fitness = rhc_co_table['best_fitness']
iters = rhc_co_table['iterations']
attempts = rhc_co_table['attempts']
...
while n in range (2, 11):
    ...
    #bestfit = regTable['best_fitness'].max()
    bestfit = regTable.loc[regTable['best_fitness'].idxmax()]
    sa_co.append(bestfit)


    n+=1
#print(sa_co)
sa_co_table = pd.DataFrame(sa_co)
sa_co_table.columns = ['Run_no', 'best_state', 'best_fitness', 'bits', 'iterations', 'attempts', 'schedule']
no_bits = sa_co_table['bits']
b_fitness = sa_co_table['best_fitness']
iters = sa_co_table['iterations']
attempts = sa_co_table['attempts']
schedule = sa_co_table['schedule']
...
while n in range (2, 11):
    ...
    #bestfit = regTable['best_fitness'].max()
    bestfit = regTable.loc[regTable['best_fitness'].idxmax()]
    ga_co.append(bestfit)


    n+=1
#print(ga_co)
ga_co_table = pd.DataFrame(ga_co)
ga_co_table.columns = ['Run_no', 'best_state', 'best_fitness', 'bits', 'iterations', 'attempts', 'pop_size', 'mprob']
no_bits = ga_co_table['bits']
b_fitness = ga_co_table['best_fitness']
iters = ga_co_table['iterations']
attempts = ga_co_table['attempts']
popsize = ga_co_table['pop_size']
mutprob = ga_co_table['mprob']
...
while n in range (2, 11):
    ...
    #bestfit = regTable['best_fitness'].max()
    bestfit = regTable.loc[regTable['best_fitness'].idxmax()]
    mim_co.append(bestfit)


    n+=1
#print(mim_co)
mim_co_table = pd.DataFrame(mim_co)
mim_co_table.columns = ['Run_no', 'best_state', 'best_fitness', 'bits', 'iterations', 'attempts', 'pop_size', 'kpct']
no_bits = mim_co_table['bits']
b_fitness = mim_co_table['best_fitness']
iters = mim_co_table['iterations']
attempts = mim_co_table['attempts']
popsize = mim_co_table['pop_size']
keeppct = mim_co_table['kpct']
