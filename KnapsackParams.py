...
while n in range (2, 11):
    ...
    rhc_f.append(bestfit)


    n+=1
#print(rhc_f)
rhc_f_table = pd.DataFrame(rhc_f)
rhc_f_table.columns = ['Run_no', 'best_state', 'best_fitness', 'bits', 'iterations', 'attempts']
no_bits = rhc_f_table['bits']
b_fitness = rhc_f_table['best_fitness']
iters = rhc_f_table['iterations']
attempts = rhc_f_table['attempts']
...
while n in range (2, 11):
    ...
    n+=1
#print(sa_f)
sa_f_table = pd.DataFrame(sa_f)
sa_f_table.columns = ['Run_no', 'best_state', 'best_fitness', 'bits', 'iterations', 'attempts', 'schedule']
no_bits = sa_f_table['bits']
b_fitness = sa_f_table['best_fitness']
iters = sa_f_table['iterations']
attempts = sa_f_table['attempts']
schedule = sa_f_table['schedule']
...
while n in range (2, 11):
    ...
    n+=1
#print(ga_f)
ga_f_table = pd.DataFrame(ga_f)
ga_f_table.columns = ['Run_no', 'best_state', 'best_fitness', 'bits', 'iterations', 'attempts', 'pop_size', 'mprob']
no_bits = ga_f_table['bits']
b_fitness = ga_f_table['best_fitness']
iters = ga_f_table['iterations']
attempts = ga_f_table['attempts']
popsize = ga_f_table['pop_size']
mutprob = ga_f_table['mprob']
...
while n in range (2, 11):
    ...
    #bestfit = regTable['best_fitness'].max()
    bestfit = regTable.loc[regTable['best_fitness'].idxmax()]
    mim_f.append(bestfit)


    n+=1
#print(mim_f)
mim_f_table = pd.DataFrame(mim_f)
mim_f_table.columns = ['Run_no', 'best_state', 'best_fitness', 'bits', 'iterations', 'attempts', 'pop_size', 'kpct']
no_bits = mim_f_table['bits']
b_fitness = mim_f_table['best_fitness']
iters = mim_f_table['iterations']
attempts = mim_f_table['attempts']
popsize = mim_f_table['pop_size']
keeppct = mim_f_table['kpct']
